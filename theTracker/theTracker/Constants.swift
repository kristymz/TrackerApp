...
//  theTracker
//
//  Created by kristy awesome pants martinez on 8/21/20.
...
struct Colors {
    ...
    static let green = UIColor(red: 255.0, green: 69.0/255.0, blue: 0.0/255.0, alpha: 1.0)
    ...
    static let white = UIColor(red: 255.0/255.0, green: 255.0/255.0, blue: 225.0/255.0, alpha: 1.0)
}
